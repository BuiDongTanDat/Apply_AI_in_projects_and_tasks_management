...
async def lifespan(app: FastAPI):
    ...
    # Reset cache LLM khi khởi động lại app, đảm bảo kết nối mới và API key mới được áp dụng
    ModelsLoader.clear_llm_cache()
    
    # Preload embedding models (tải về local nếu chưa có, load vào cache)
    ModelsLoader.preload_embeddings()
