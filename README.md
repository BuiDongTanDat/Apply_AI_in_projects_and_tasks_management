...
# Taskee - A modern, AI-powered project & task management platform
...
4. [AI Service](#ai-service)
      - [Tech Stack](#ai-service-tech-stack)
      - [Getting Started](#ai-service-getting-started)
      - [Project Structure](#ai-service-project-structure)
...
How it work? Let watch the [video](https://youtu.be/1fqZCE97Y44).
